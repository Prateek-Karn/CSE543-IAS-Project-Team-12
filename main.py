...
image_path = "ndjsontopng/reconstructed_image_4550984434974720.png"  # Your image path
...
add_noise_to_drawing('challenge_created/reconstructed_image_4550984434974720_no_border.png')


#Doing Similarity Check 

result = calculate_similarity("blockedregion_images/reconstructed_image_4550984434974720_blocked.png", "plain_user_drawing.png")
