...
add_noise_to_drawing('challenge_created/reconstructed_image_4520796586246144_no_border.png')


#Doing Similarity Check 

result = calculate_similarity("blockedregion_images/reconstructed_image_4520796586246144_blocked.png", "plain_user_drawing.png")
